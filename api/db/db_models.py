...
class Knowledgebase(DataBaseModel):
    ...
    subject_category = CharField(max_length=100, null=True, help_text="subject category", index=True)
    course_code = CharField(max_length=50, null=True, help_text="course code", index=True)
    dept_code = CharField(max_length=50, null=True, help_text="department code", index=True)
    visibility = CharField(max_length=20, null=True, default="private", help_text="visibility: private|department|public", index=True)
    owner_id = CharField(max_length=100, null=True, help_text="owner user ID", index=True)
